...
echo System-MAP | gmx_mpi trjconv -f ../../3-refinement-wat/3-Map-Scaling/step3_input_xtc.pdb -s ../0-Production/rep-00/production.tpr -n ../../3-refinement-wat/0-Building/index.ndx -o conf_map.pdb
